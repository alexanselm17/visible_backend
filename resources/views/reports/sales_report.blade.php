...
<body>
    <div class="header">
        <a href="{{ route('download.sales_report', ['shiftId' => $shift->id, 'petrolStationId'=>$petrolStation->id]) }}" class="download-button">Download PDF</a>
          ...
          <table>
            <thead>
                <tr>
                    ...
                    <th>Tank Name</th>
                    <th>Product</th>
                    <th>Start Vol (Litres)</th>
                    <th>End Vol (Litres)</th>
                    <th>Qty Sold</th>
                    <th>Cash</th>
                </tr>
            </thead>
