...
<body>
    ...
    <div class="overal-report">
        <div>
            <h2>Completed: Ksh. {{ number_format($completed_count ?? 0) }}</h2>
            <h2>Incompletes: Ksh. {{ number_format($incomplete_count ?? 0) }}</h2>
            <h2>Still Ongoing: Ksh. {{ number_format($ongoing_count ?? 0) }}</h2>
